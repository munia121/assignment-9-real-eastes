    ...
    return (
        <div className="mt-10">
            ...
            <Swiper
                ...
                className="mySwiper">
                <SwiperSlide >
                    <div className='h-[600px] bg-no-repeat bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/3ctZThp/mountain-retreat.jpg)` }}>
                ...
                {/* ********* */}
                <SwiperSlide>
                    <div className='h-[600px] bg-no-repeat bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/fpG6PXY/Header-The-Most-Expensive-Beachfront-Vacation-Rental-in-Every-Country.jpg)` }}>
                ...
                {/* ********** */}
                <SwiperSlide>
                    <div className='h-[600px] bg-no-repeat bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/3WfP2Yx/studenthousing1.jpg)` }}>
                ...
                {/* ********* */}
                <SwiperSlide>
                    <div className='h-[600px] bg-no-repeat bg-cover' style={{ backgroundImage: `url(https://i.ibb.co/vVShkWm/modern-townhouse-design-house-168058-939.jpg)` }}>
